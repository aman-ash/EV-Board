        ...
        <div className="body">
          <form method="POST" onSubmit={handleSubmit(onSubmit)}>
            <div className="mb-3">
              ...
              <i
                className="with-tooltip fa fa-question-circle"
                data-tooltip-content="Must have atleast 3 characters & should not start with numbers."
              ></i>
              <input
                type="text"
                name="firstName"
                {...register("firstName", {
                  ...
                  validate: {
                    starstwithNumerical: (value) =>
                      !/^\d/.test(value) || "Should not start with Number",
                    hasMinLength: (value) =>
                      value.length >= 3 || "Must have atleast 3 characters",
                  },
                })}
            ...
            <div className="mb-3">
              ...
              <i
                className="with-tooltip fa fa-question-circle"
                data-tooltip-content="Must have atleast 8 characters & 1 uppercae, 1 lowercase, 1 special and 1 numerical character"
              ></i>
              <input
                type="password"
                name="password"
